...
// not pure component becouse refs
class FinanceDetailPending extends Component {
      ...
      Linking.canOpenURL(url)
        .then((supported) => {
          if (!supported) {
            ...
            Alert.alert('Oops...', `Can't handle url:${url}`);
          } else {
  ...
  render() {
    ...
    const indentifier = data.gig.identifier;
    return (
      <View style={{
        display: 'flex',
...
export default FinanceDetailPending;
